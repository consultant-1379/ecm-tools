...
from utils import BLOCK_SIZE, check_onsite_disk_space_restore, \
...
class OffsiteBackupHandler:
    ...
    def __init__(self, gpg_manager, offsite_config, enmaas_config_dic,
                 number_threads, number_processors, notification_handler, logger, rsync_ssh=True):
        """
    ...
    def download_backup_from_offsite(self, customer_name, backup_tag, backup_path_to_retrieve,
        ...
        transfer_time = []
        rsync_output = transfer_file(source_remote_dir, backup_restore_destination, self.rsync_ssh,
    ...
    def check_disk_space_upload(self, max_required_space_mb, block_size):
        ...
        """
        # current offsite storage is blob fuse.
        # In this case, the following lines will check the VM's SSD, not blob fuse,
        # which will give logically incorrect result.
        # However, the functionality is valid.
