...
RSYNC_SSH_ARGS = "-ahe ssh"
RSYNC_DAEMON_ARGS = "-ah"
...
class RsyncManager:
    ...
    def __init__(self, source_path, destination_path, retry=3, rsync_ssh=True):
        """
    ...
    def send(self):
        ...
        try:
            ...
            if self.rsync_ssh:
                ...
                rsync_args = RSYNC_DAEMON_ARGS
                destination_path = "{}{}".format(RSYNC_MODULE,
                                                 self.destination_path.replace(":",
                                                                               RSYNC_DAEMON_DESTINATION))
